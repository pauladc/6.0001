...
class TestPS4A(unittest.TestCase):
    ...
    def test_is_min_heap(self):
        ...
        # tr3 = Node(8, Node(2, Node(1), Node(5)), Node(10))
        # tr4 = Node(1, Node(2, Node(3), Node(5)), Node(10))
        ...
        # st_tr3 = student.is_heap(tr3,compare_func)
        # self.assertFalse(st_tr3,"Expected False but got True")
        # st_tr4 = student.is_heap(tr4,compare_func)
        # self.assertTrue(st_tr4,"Expected True but got False")
